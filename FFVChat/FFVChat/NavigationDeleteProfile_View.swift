//
//  NavigationDeleteProfile_View.swift
//  FFVChat
//
...
class NavigationDeleteProfile_View: UIView
{

    weak var viewController : DeleteProfile_ViewController!
    
    var backButton : UIButton!
    
    var tittle : UILabel!
    
    init(requester: DeleteProfile_ViewController)
    {
        ...
        self.tittle.text = "Delete Profile"
