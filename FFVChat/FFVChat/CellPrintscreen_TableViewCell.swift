...
//        self.photo.layer.cornerRadius = self.photo.frame.size.width/2
        ...
        self.title = UILabel(frame: CGRectMake(self.photo.frame.origin.x + self.photo.frame.size.width + 10, 10, screenWidth - 70, 40))
        ...
        self.details = UILabel(frame: CGRectMake(self.title.frame.origin.x, self.title.frame.origin.y + self.title.frame.size.height, self.title.frame.size.width, 50))
        self.details.textAlignment = .Left
        self.details.font = UIFont(name: "Helvetica", size: 13)
